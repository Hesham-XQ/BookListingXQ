...
public class MainActivity extends AppCompatActivity implements LoaderManager.LoaderCallbacks<List<Book>>  {
 ...
 private static final String QUERY_PARAM_IN_AUTHOR = "inauthor:";
    ...
    final String STRING_BASE_URL =
            "https://www.googleapis.com/books/v1/volumes?q=subject:fiction+printType=books&maxResults=40&orderBy=newest";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        titleSearchInput = (EditText) findViewById(R.id.search_box);
        authorSearchInput = (EditText) findViewById(R.id.search_box_author);
        ...
        bookSearchResultsListView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                // create an Intent
                Intent openBookDetailsActivity = new Intent(getApplicationContext(), DetailsActivity.class);
    ...
    public void informAboutNoNetworkConnection() {
        ...
        if (booksArrayList.size() < 1) {
         ...
         //todo   noNetworkConnection.setImageResource(R.drawable.ic_launcher_background);
    ...
    public String prepareSearchQuery() {
        ...
        String titleQueryFormatted = QueryUtils.formatStringForUrl(titleSearchStringUnformatted);
        String authorQueryFormatted = QueryUtils.formatStringForUrl(authorSearchStringUnformatted);
