...
import com.example.android.booklistingxq.Book;
import com.example.android.booklistingxq.QueryUtils;
...
public class BookLoader extends AsyncTaskLoader<List<Book>> {
    ...
    public List<Book> loadInBackground() {
        ...
        List<Book> bookList = QueryUtils.getDataFromHttp(urlString);
        return bookList;
    }
